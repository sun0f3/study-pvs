...
commands = ['flex', 'bison', 'c99 -c', 'gcc -c', '-@rm -f','$(DROPPER)', '$(STOPPER)', 'dot -Tpng', '$(PDFLATEX)', 'c99 ', 'gcc ', 'ld ', 'pdflatex', 'autogen', 'doxygen', 'valgrind', 'check', 'makedot2dot', 'makesimple', 'dot2tex', 'cc -c', 'cc ']
#extcommands = {'MAKE_GRAPHER'}
